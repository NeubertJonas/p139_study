...
## Complete versus Partial Data

As the data collection is still ongoing, the raw data contains both complete and partial data sets. Let's have a closer look at that:

```{r}
#| tbl-cap-location: margin
library(kableExtra)
kable(arrange(combination[,1:2], ID),
      caption = "Data availablility per participant. 0: Baseline; 1_FU1: 1st block, follow-up in the lab; 1_FU2: 1st block, follow-up at home")
```
